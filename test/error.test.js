...
describe('error module', () => {
  ...
  describe('error', () => {
    ...
    it('should report more than one expectation', () => {
      expect(message(error(t, ['foo', 'bar']))).toEqual(
        'Expected one of foo, bar got a at character 0'
      );
    });

    it('should report a single expectation', () => {
      expect(message(error(t, ['foo']))).toEqual(
        'Expected foo got a at character 0'
      );
    });
    ...
    it('should report the end of string', () => {
      ...
      expect(message(error(t, ['foo']))).toEqual(
        'Expected foo got end of string'
      );
    });
  });
