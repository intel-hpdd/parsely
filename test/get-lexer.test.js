...
describe('The lexer', () => {
  ...
  describe('tokenizing', () => {
    ...
    it('should tokenize a simple expression', () => {
      expect(tokenizer('type = alert and severity = Warning')).toEqual([
        {
          content: 'type',
          name: 'value',
          start: 0,
    ...
    it('should tokenize errors', () => {
      expect(tokenizer('type = 23 and')).toEqual([
        {
          content: 'type',
          name: 'value',
          start: 0,
    ...
    it('should handle a string ending in errors', () => {
      expect(tokenizer('type = 23')).toEqual([
        {
          content: 'type',
          name: 'value',
          start: 0,
    ...
    it('should handle a string starting in errors', () => {
      expect(tokenizer('23 = foo')).toEqual([
        {
          content: '23',
          name: 'error',
          start: 0,
    ...
    it('should handle a string with multiple errors', () => {
      expect(tokenizer('23 = 24')).toEqual([
        {
          content: '23',
          name: 'error',
          start: 0,
